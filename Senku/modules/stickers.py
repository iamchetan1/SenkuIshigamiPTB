...
from Senku.events import register as Senku
from Senku import LOGGER
from Senku import TEMP_DOWNLOAD_DIRECTORY
from Senku import telethn as bot
...
async def drawText(image_path, text):
    ...
    if os.name == "nt":
        ...
        fnt = "./Senku/resources/ArmWrestler.ttf"
