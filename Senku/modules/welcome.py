...
import Senku.modules.sql.welcome_sql as sql
from Senku import (DEV_USERS, LOGGER, OWNER_ID, DRAGONS, DEMONS, TIGERS,
...
from Senku.modules.helper_funcs.msg_types import get_welcome_type
    ...
    if should_goodbye:
        ...
        if left_mem:
            ...
            if left_mem.id == OWNER_ID:
                update.effective_message.reply_text(
                    "Damn! The Founder left!..", reply_to_message_id=reply)
                return
