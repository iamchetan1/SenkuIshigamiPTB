...
def get_user_list(__init__, key):
    with open("{}/Senku/{}".format(os.getcwd(), __init__), "r") as json_file:
        return json.load(json_file)[key]

# enable logging
FORMAT = "[Senku] %(message)s"
logging.basicConfig(
...
LOGGER.info("Senku is starting. Licensed under GPLv3.")
LOGGER.info("Bot based on Dr Stone.")
LOGGER.info("Maintained by Senku Ishigami")
...
from Senku.modules.helper_funcs.handlers import (
